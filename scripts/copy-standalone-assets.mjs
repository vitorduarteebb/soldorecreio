 ...
 * Sem esta cópia, CSS/JS/fontes retornam 404 e a página fica sem estilo.
...
if (!existsSync(standalone)) {
  console.error(
    "[copy-standalone] .next/standalone não encontrado. Rode `next build` com output: 'standalone'.",
  );
  process.exit(1);
}
